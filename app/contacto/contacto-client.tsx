...
const contactData = {
  ...
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Cra. 73 #45f-23, Laureles",
    "addressLocality": "Medellín",
    "addressRegion": "Antioquia",
    "addressCountry": "CO"
  },
  "url": "https://www.terapiaparejamedellin.com/contacto",
  "sameAs": [
    "https://www.instagram.com/sinapser",
    "https://wa.me/573137415861"
  ],
  "openingHoursSpecification": [
    {
      ...
      "opens": "08:00",
      "closes": "18:00",
      "comment": "Consultas presenciales"
    },
    {
      "@type": "OpeningHoursSpecification",
      "dayOfWeek": "Saturday",
...
export default function ContactoPageClient(): JSX.Element {
    ...
    const instagramUser: string = "@sinapser";
                ...
                <div className="container mx-auto py-20 px-4 md:px-8 relative">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className={`bg-card rounded-3xl p-8 shadow-xl border border-border h-full transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 delay-100 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
                            ...
                            <Button asChild className="group bg-gradient-to-r from-primary-foreground to-accent text-white hover:opacity-90 rounded-full px-8 py-6 text-lg shadow-md hover:shadow-lg transition-all">
                        ...
                        <div className={`bg-card rounded-3xl p-8 shadow-xl border border-border h-full transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 delay-200 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
                            ...
                            <div className="rounded-xl overflow-hidden mb-8 h-64 relative shadow-md">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.195971484553!2d-75.5979836852309!3d6.237976895484898!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e442994a5e3a3f5%3A0x4a7e9e8f0b7c3e8e!2sCra.%2073%20%2345f-23%2C%20Laureles%20-%20Estadio%2C%20Medell%C3%ADn%2C%20Antioquia!5e0!3m2!1ses-419!2sco!4v1662580795535!5m2!1ses-419!2sco"
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
                    ...
                    <div className={`mt-20 transition-all duration-700 delay-600 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
                        ...
                        <div className="max-w-2xl mx-auto bg-card rounded-3xl p-10 shadow-xl border border-border">
                            <form className="space-y-6">
                                ...
                                <Button asChild className="group w-full bg-gradient-to-r from-primary-foreground to-accent text-white rounded-full py-6 mt-4 shadow-md hover:shadow-lg transition-all">
                                    <a href={whatsappLink} target="_blank" rel="noopener noreferrer">
                                        Enviar Mensaje
                                        <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
                                    </a>
